...
process.on("SIGTERM", async () => {
  ...
  await Promise.all([buildQueue.pause(true), evaluationQueue.pause(true)]);
  await Promise.all([buildQueue.close(), evaluationQueue.close()]);
